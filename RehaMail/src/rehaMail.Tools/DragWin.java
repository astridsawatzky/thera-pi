...
public class DragWin extends MouseAdapter {
     ...
     * public Cursor cnsize = new Cursor(Cursor.N_RESIZE_CURSOR);
     * // @jve:decl-index=0: public Cursor cnwsize = new
     * Cursor(Cursor.NW_RESIZE_CURSOR); // @jve:decl-index=0: public Cursor cnesize
     * = new Cursor(Cursor.NE_RESIZE_CURSOR); // @jve:decl-index=0: public Cursor
     * cswsize = new Cursor(Cursor.SW_RESIZE_CURSOR); // @jve:decl-index=0: public
     * Cursor cwsize = new Cursor(Cursor.W_RESIZE_CURSOR); // @jve:decl-index=0:
     * public Cursor csesize = new Cursor(Cursor.SE_RESIZE_CURSOR);
     * // @jve:decl-index=0: public Cursor cssize = new
     * Cursor(Cursor.S_RESIZE_CURSOR); // @jve:decl-index=0: public Cursor cesize =
     * new Cursor(Cursor.E_RESIZE_CURSOR); // @jve:decl-index=0: public Cursor
     * cdefault = RehaMail.thisClass.normalCursor; // @jve:decl-index=0:
     */
