...
public class ToolsDialog extends JXDialog
        implements FocusListener, ActionListener, MouseListener, WindowListener, KeyListener, RehaTPEventListener {
    ...
    private JXPanel getContent(JList list) {
         ...
         * abfeuern.setActionCommand("abfeuern"); abfeuern.addActionListener(this);
    ...
    public void activateListener() {
        toolsMl = new MouseListener() {
            ...
            public void mouseClicked(MouseEvent arg0) {
                 ...
                 * SystemConfig.hmPatientenWerkzeugDlgIni.get("ToolsDlgClickCount")){ if(
                 * ((JComponent)arg0.getSource()) instanceof JList){ RehaMail.toolsDlgRueckgabe
                 * = Integer.valueOf(jList.getSelectedIndex()); FensterSchliessen("dieses"); } }
                 */
