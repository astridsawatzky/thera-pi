...
public class RTFEditorPanel extends JXPanel implements FocusListener {
    ...
    private JToolBar getToolBar(boolean mitsavebutton) {
        ...
        // bar.add((buts[0]=ButtonTools.macheButton("<html><div style='width: 25px;
        // height: 25px;'><b>B</b></div></html>", "fett", al)) );
            ...
            if (selend > 0 && selend != selstart) {
                ...
                SwingUtilities.invokeLater(new Runnable() {
                    ...
                    public void run() {
                        ...
                        editorArea.select(selend, editorArea.getDocument()
                                                            .getLength());
    ...
    public void doSchriftArt() {
        ...
        MutableAttributeSet attr = new SimpleAttributeSet();
        StyleConstants.setFontFamily(attr, box1.getSelectedItem()
                                               .toString());
        editorArea.setCharacterAttributes(attr, false);
    }
    ...
    public void doSchriftGroesse() {
        ...
        MutableAttributeSet attr = new SimpleAttributeSet();
        StyleConstants.setFontSize(attr, Integer.parseInt(box2.getSelectedItem()
                                                              .toString()));
        editorArea.setCharacterAttributes(attr, false);
    }
