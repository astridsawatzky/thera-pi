        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                try {
                    ...
                    // mailTab.addTab("RTF-Editor",RehaMail.attachmentIco[5],editorPanel=new
                    // RTFEditorPanel());

                    mailTab.addTab("eingegangene Nachrichten", RehaMail.attachmentIco[5], mailPanel);
                    mailTab.addTab("gesendete Nachrichten", RehaMail.attachmentIco[6],
                            (sendPanel = new SendMailPanel()));
                    mailTab.addTab(ToDoPanel.setTabTitel(), RehaMail.symbole.get("todo"),
                            (todoPanel = new ToDoPanel()));
                    /*
                     * DropTarget dndt = new DropTarget(); DropTargetListener dropTargetListener =
                     * new DropTargetListener() { public void dragEnter(DropTargetDragEvent e) {}
                     * public void dragExit(DropTargetEvent e) {} public void
                     * dragOver(DropTargetDragEvent e) {} public void drop(DropTargetDropEvent e) {
                     * 
                     * }
                     * 
