...
public class SysVars extends JDialog implements MouseListener, KeyListener {
    ...
    private void macheTexte() {
        sysTexte = Arrays.asList(new String[] { "erstes Behandlungsdatum", "letztes Behandlungsdatum", "Rezeptdatum",
                "Anrede", "Pat. Nachname", "Pat. Vorname", "Heutiges Datum", "Tabulator",
                /* "Zeilenumbruch", */"...Der Patient / Die Patientin", "...der Patient / die Patientin",
                "...Dem Patient / Der Patientin", "...dem Patient / der Patientin", "...Den Patient / Die Patientin",
                "...den Patient / die Patientin", "...des Patient / der Patientin", "...ihm / ihr", "...Sein / Ihr",
                "...sein / ihr", "...Seine / Ihre", "...seine / ihre", "...Er / Sie", "...er / sie" });

    }

    private void macheSysVars1() {
        sysVars1 = Arrays.asList(new String[] { "^ErstDatum^", "^LetztDatum^", "^RezDatum^", "^Anrede^", "^PatName^",
                "^PatVName^", "^Heute^", "^Tab^", /* "^CRLF^", */"^DerPat/DiePat^", "^derPat/diePat^",
                "^DemPat/DerPat^", "^demPat/derPat^", "^DenPat/DiePat^", "^denPat/diePat^", "^desPat/derPat^",
                "^ihm/ihr^", "^Sein/Ihr^", "^sein/ihr^", "^Seine/Ihre^", "^seine/ihre^", "^Er/Sie^", "^er/sie^"
