...
public class OpRgaf implements WindowListener {
    ...
    public static void main(String[] args) {
        ...
        if (args.length > 0 || testcase) {
            if (!testcase) {
                ...
                mahnParameter.put("einzelmahnung", inif.getIntegerProperty("General", "EinzelMahnung")
                ...
                mahnParameter.put("inofficestarten", inif.getIntegerProperty("General", "InOfficeStarten")
                                                         .equals("1") ? Boolean.TRUE : Boolean.FALSE);
    ...
    public JFrame getJFrame() {
        ...
        jFrame.setTitle("Thera-Pi  Rezeptgebührrechnung/Ausfallrechnung/Mahnwesen  [IK: " + aktIK + "] "
