...
/**
 * analog IntegerCellEditor by oracle
 *
 */
public class MoneyCellEditor extends DefaultCellEditor {
    private static final Logger logger = LoggerFactory.getLogger(MoneyCellEditor.class);
    ...
    public Object getCellEditorValue() {
        ...
        if (o instanceof Money) {
            ...
            logger.error("getCellEditorValue isn't Money", o);
            return null;
