...
class InitHashMaps {
    ...
    public InitHashMaps() {
        ...
        List<String> lAdrRDaten = Arrays.asList(new String[] { "<Rpatid>", "<Rnummer>", "<Rdatum>", "<Rposition1>",
                ...
                "<Rletztdat>", "<Rid>", "<Rtage>", "<Rkurz1>", "<Rkurz2", "<Rkurz3>", "<Rkurz4>", "<Rlang1>",
                "<Rlang2>", "<Rlang3>", "<Rlang4>", "<Rbarcode>", "<Systemik>", "<Rwert>", "<Rhbpos>", "<Rwegpos>",
                "<Rhbpreis>", "<Rwegpreis>", "<Rhbproz>", "<Rwegproz>", "<Rhbanzahl>", "<Rweganzahl>", "<Rhbgesamt>",
                "<Rweggesamt>", "<Rwegkm>", "<Rtage>" });
