...
public class ColAlignRenderer extends JLabel implements TableCellRenderer {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus,
        ...
        /*
         * setBackground( (Color) table.getValueAt(row, column-2) ); setForeground(
         * (Color) table.getValueAt(row, column-1) );
         * 
         * 
         * if(value instanceof JLabel){ if( ((JLabel)value).toString().equals("")){
         * //setText("Demo-Text"); }else{ setText( ((JLabel)value).getText() ); } }
         */
        return this;
    }
