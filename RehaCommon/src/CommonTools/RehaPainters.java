...
public final class RehaPainters {
    ...
    public static CompoundPainter<?> getBlauGradientPainter() {
        /*
         * BasicGradientPainter gradient = new BasicGradientPainter( new
         * GradientPaint(new Point2D.Double(0.0, 0.0), new Color(0xd67801), new
         * Point2D.Double(0.0, 1.0), new Color(0xb35b01)));
         */
        MattePainter mp = new MattePainter(Colors.TaskPaneBlau.alpha(1.0f));
    ...
    public static CompoundPainter getSchwarzGradientPainter() {
        ...
        // set the background painter
        LinearGradientPaint lgp = new LinearGradientPaint(new Point(0, 0), new Point(1, 0), new float[] { 0.0f, 1.0f },
                new Color[] { Colors.TaskPaneBlau.alpha(1.0f), new Color(255, 255, 255) });
    ...
    Painter getPaint() {
        ...
        Color end = new Color(Math.min(start.getRed() + 30, 255), Math.min(start.getGreen() + 30, 255),
