...
// Lemmi Doku: Der erste Wert sagt, was angezeigt wird, der zweite Wert ist der Rückgabewert bei der Benutzerauswahl
    ...
    /*
     * public Object getSecValue(){ if(this.startElement.equals("")){ return
     * ((Object)((Vector<?>)vec.get(this.getSelectedIndex())).get(this.cmbretvalue)
     * ); }else{ return
     * ((Object)((Vector<?>)vec.get(this.getSelectedIndex()-1)).get(this.
     * cmbretvalue) ); }
     * 
     * }
     */
