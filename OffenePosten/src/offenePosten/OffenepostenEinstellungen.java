...
public class OffenepostenEinstellungen extends JXPanel {
    ...
    private void doSpeichern() {
        int anfrage = JOptionPane.showConfirmDialog(null,
                "Wollen Sie die aktuellen Einstellungen dauerhaft übernehmen?", "Benutzeranfrage",
        ...
        iwert = Integer.parseInt((tfs[1].getText()
                                        .equals("") ? "11" : tfs[1].getText()));
        inif.setIntegerProperty("General", "TageBisMahnung2", iwert, null);
        OffenePosten.mahnParameter.put("frist2", iwert);

        iwert = Integer.parseInt((tfs[2].getText()
                                        .equals("") ? "11" : tfs[2].getText()));
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null,
                    "Datumswert für 'Alles ausblenden..' falsch eingegeben, nehme den 01.01.1995");
        }
