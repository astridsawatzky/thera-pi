...
public class Rechte {
    public static boolean hatRecht(int recht, boolean dialogzeigen) {
        if (Reha.progRechte.substring(recht, recht + 1)
                           .equals("1")
                || Reha.progRechte.substring(BenutzerSuper_user, BenutzerSuper_user + 1)
                                  .equals("1")) {
            return true;
        }
        if (dialogzeigen) {
    ...
    public static boolean testeRecht(String rechte, int recht) {
        if (rechte.substring(recht, recht + 1)
                  .equals("1")) {
            return true;
        }
        return false;
    ...
    private static String[] rechteExt = { "Benutzerverwaltung öffnen", "Benutzerrechte ändern", "Super-User",
            ...
            "Neuen Patient anlegen", "Patientendaten ändern", "Patientendaten ändern", "Patient löschen",
            "Email an Patient versenden", "SMS an Patient versenden", "Zusatzinformationen einsehen",

            "Rezepte neu anlegen", "Rezepte ändern", "Rezepte löschen", "Rezeptgebühren kassieren",
            "Ausfallrechnungen erstellen", "Rezepte abschließen", "Rezepte aufschließen",
            "Privat- und BGE-Rechnungen erstellen", "Therapieberichte erstellen",

            "Gesamtumsatz des Patienten ermitteln", "Tage eines Historienrezeptes drucken",
            "Nachträglich Therapieberichte erstellen",

            "Therapieberichte ändern", "Therapieberichte löschen",

            "Dokumentation öffnen", "Dokumentation scannen", "Dokumentation löschen",
            "Grafik- und OOorg-Dokumente erstellen",

            "Gutachten anlegen", "Gutachten ändern", "Gutachten löschen", "Stammdaten auf neues Gutachten übertragen",

            "Eintrag nur in freie Termine erlauben", "Termine vollständig eintragen / ändern", "Termine löschen",
            "Behandlungen bestätigen", "Termine gruppieren", "Termin Drag & Drop",
            ...
            "Urlaub-/Überstunden ermitteln", "Offene-Posten starten", "Kassenbuch anlegen/ändern",
            "Rez.Gebühr bezahlt/unbezahlt ändern", "unbelegt-4", "unbelegt-5", "unbelegt-6", "unbelegt-7", "unbelegt-8",
            "unbelegt-9", "unbelegt-10",

            "Firmenangaben Mandanten", "Datenbankparameter", "Kalender Grundeinstellungen",
            ...
            "Verkaufsmodul benutzen", "Rehaformulare verwenden", "Textbausteine für Gutachten anlegen/ändern",
            "Rezepte transferieren", "im Rezept gespeicherte Behandlungsarten löschen", "Geburtstagsbriefe erstellen",
            "Sql-Modul verwenden", "Reha-Fallsteuerung nach §301", "Darf Thera-Pi-Nachrichten löschen",
            "Artikel in Verkaufsmodul-Modul anlegen", "unbelegt-8", "unbelegt-9", "unbelegt-10"
