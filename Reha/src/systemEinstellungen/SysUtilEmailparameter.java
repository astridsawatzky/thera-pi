...
public class SysUtilEmailparameter extends JXPanel implements KeyListener, ActionListener {
    ...
    private JPanel getVorlagenSeite() {
        ...
        Authent.setSelected((SystemConfig.hmEmailExtern.get("SmtpAuth")
                                                       .equals("0") ? false : true));
         ...
         * hmEmailExtern.put("SmtpHost",String.valueOf(ini.getStringProperty(
         * "EmailExtern","SmtpHost")));
         * hmEmailExtern.put("SmtpAuth",String.valueOf(ini.getStringProperty(
         * "EmailExtern","SmtpAuth")));
         * hmEmailExtern.put("Pop3Host",String.valueOf(ini.getStringProperty(
         * "EmailExtern","Pop3Host")));
         * hmEmailExtern.put("Username",String.valueOf(ini.getStringProperty(
         * "EmailExtern","Username"))); String pw =
         * String.valueOf(ini.getStringProperty("EmailExtern","Password"));
         * Verschluesseln man = Verschluesseln.getInstance();
         * man.init(Verschluesseln.getPassword().toCharArray(), man.getSalt(),
         * man.getIterations()); String decrypted = man.decrypt (pw);
         * hmEmailExtern.put("Password",String.valueOf(decrypted));
         * hmEmailExtern.put("SenderAdresse",String.valueOf(ini.getStringProperty(
         * "EmailExtern","SenderAdresse")));
         * hmEmailExtern.put("Bestaetigen",String.valueOf(ini.getStringProperty(
         * "EmailExtern","EmpfangBestaetigen")));
         ********/
        ...
        // "p, 5dlu, p, 10dlu, p, 2dlu, p, 10dlu, p, 10dlu, p, 2dlu, p, 2dlu, p, 2dlu,
        // p, 2dlu, p, 2dlu, p, 10dlu, p, 10dlu, p, 10dlu, p, 10dlu, p");
        ...
        // Hier k�nnen Sie bis zu zwei E-Mail-Postf�cher f�r programminterne Funktionen
        // einrichten (z.B. Terminlisten mailen).
        // Die Zugangsdaten f�r Ihre E-Mailpostf�cher erhalten Sie von Ihrem
        // Internetprovider.
        ...
        FormLayout lay1 = new FormLayout("right:max(60dlu;p), 10dlu, 140dlu,70px, right:p",
                "5dlu,p,5dlu,p,5dlu,p,2dlu,p,5dlu");
        PanelBuilder builder1 = new PanelBuilder(lay1);
        CellConstraints cc1 = new CellConstraints();
        builder1.getPanel()
                .setOpaque(false);

        // builder.add(new JLabel(""), cc.xyw(3, 1,
        // 3,CellConstraints.FILL,CellConstraints.DEFAULT));
        ...
        builder1.addLabel(
                "Achtung: nur(!) wenn Sie nach dem Test eine Re-Email erhalten war die Einrichtung erfolgreich.",
                cc1.xyw(1, 6, 5));
    ...
    private void datenSpeichern(HashMap<String, String> mailmap, String postfach) {
        try {
            String sender = Mailadresse.getText()
                                       .trim();
            ...
            String smtphost = SMTPhost.getText()
                                      .trim();
            String pophost = POPhost.getText()
                                    .trim();
            ...
            INIFile ini = INITool.openIni(Path.Instance.getProghome() + "ini/" + Reha.getAktIK() + "/", "email.ini");
            ...
            ini.setStringProperty(postfach, "SmtpSecure", Secure.getSelectedItem()
                                                                .toString(),
                    null);
            ini.setStringProperty(postfach, "SmtpPort", useport, null);

            INITool.saveIni(ini);
            JOptionPane.showMessageDialog(null, "Emailparameter für --> " + Postfach.getSelectedItem()
                                                                                    .toString()
                    + " <-- wurden erfolgreich gespeichert");
        } catch (Exception ex) {
            JOptionPane.showMessageDialog(null,
                    "Fehler beim speichern der Emailparameter für --> " + Postfach.getSelectedItem()
                                                                                  .toString()
                            + " <-- !!!!!");
        }
    ...
    private void wechsleEmail() {
        ...
        EmpfBest.setSelected((hmEmail.get("Bestaetigen")
                                     .equals("0") ? false : true));
        ...
        Authent.setSelected((hmEmail.get("SmtpAuth")
                                    .equals("0") ? false : true));
    ...
    private void testeEmail() {
        ...
        if (Secure.getSelectedItem()
                  .toString()
                  .equals("keine")) {
            smtpport = useport;
            popport = "110";
        } else if (Secure.getSelectedItem()
                         .toString()
                         .equals("TLS/STARTTLS")) {
            smtpport = useport;
            popport = "995";
        ...
        String meldung = "Hostname (Mailausgang) = " + smtphost + "\n" + "SMTP-Port = " + UsePort.getText() + "\n"
                ...
                + (authx ? "JA" : "NEIN") + "\n" + "Sicherheitsstufe = " + Secure.getSelectedItem()
                                                                                 .toString()
                + "\n";
        ...
        try {
            boolean success = oMail.sendMail(smtphost, benutzer, pass1, sender, sender, "Test der Emailkonfiguration",
                    text + "\n\n" + meldung, attachments, authx, bestaetigen, Secure.getSelectedItem()
                                                                                    .toString(),
                    useport);
            ...
            JOptionPane.showMessageDialog(null,
                    "Emailversand fehlgeschlagen\n\n" + "Mögliche Ursachen:\n"
                            + "- falsche Angaben zu Ihrem Emailpostfach und/oder dem Provider\n"
                            + "- Sie haben kein Kontakt zum Internet\n\nException="
                            + (e.getMessage() == null ? "keine Angaben"
                                    : e.getMessage()
                                       .toString()));
            e.printStackTrace();
        }
