...
//      add(getKnopfPanel(),BorderLayout.SOUTH);
    ...
    private void fuelleMitWerten() {
        ...
        // hmContainer.put("PatientOpti", inif.getIntegerProperty("Container",
        // "ImmerOptimieren"));
         ...
         * Reha.getAktIK() + "/", "kasse.ini"); int forms =
         * inif.getIntegerProperty("Formulare", "KassenFormulareAnzahl"); Vector<String>
         * vec = new Vector<String>(); for (int i = 1; i <= forms; i++) { vec.clear();
         * vec.add(inif.getStringProperty("Formulare", "KFormularText" + i));
         * vec.add(inif.getStringProperty("Formulare", "KFormularName" + i));
         * modvorlagen.addRow((Vector) vec.clone()); } if (modvorlagen.getRowCount() >
        ...
        /*
         * int lang = SystemConfig.vPreisGruppen.size(); vec = new Vector<String>();
         * String wert = ""; for(int i = 0;i < lang;i++){ vec.clear(); wert =
         * SystemConfig.vPreisGruppen.get(i); vec.add(wert);
         * vec.add(zzregel[SystemConfig.vZuzahlRegeln.get(i)]); //abpr�fen welche
         * Disziplin!!!! wert = SystemConfig.vNeuePreiseAb.get(0).get(i); vec.add(wert);
    ...
    private JPanel getVorlagenSeite() {
         ...
         * button[1] = new JButton("hinzufügen"); button[2] = new JButton("entfernen");
         * // buttons 3-5 f�r Vorlagenverwaltung
         ...
         * button[4].setActionCommand("neuvorlage"); button[4].addActionListener(this);
         * 
         ...
         */
        /*
         * modvorlagen.setColumnIdentifiers(new String[] { "Titel der Vorlage",
         * "Vorlagendatei" }); vorlagen = new JXTable(modvorlagen);
         ...
         * (svorlage.equals("")) { return; } modvorlagen.setValueAt(svorlage, row, col);
         * vorlagen.validate(); } } } }); vorlagen.getColumn(0) .setCellEditor(new
         * TitelEditor()); vorlagen.setSortable(false);
         * 
         * newgroup = new JRtaTextField("GROSS", true); newdoc = new
         * JRtaTextField("GROSS", true);
         * 
         * zuza = new JComboBox();
         */
         ...
         * jscrPane.getVerticalScrollBar().setUnitIncrement(15); jscrPane.validate();
         * builder.add(jscrPane, cc.xyw(1,9, 6));
         */

        //// bis hierher abschalten
        /*
         * builder.addLabel("aus Liste entfernen", cc.xy(1,11)); builder.add(button[0],
         * cc.xy(6, 11));
         * 
         * builder.addLabel("neuer Gruppenname", cc.xy(1, 13)); builder.add(newgroup,
         * cc.xyw(3, 13, 4)); builder.addLabel("Zuzahlungsregel der Tarifgruppe",
         * cc.xy(1, 15)); builder.add(zuza, cc.xyw(3,15,4));
         * builder.addLabel("zu Liste hinzuf�gen", cc.xy(1, 17)); builder.add(button[1],
         * cc.xy(6, 17));
         */
        //// bis hierher abschalten
        /*
         ...
         * 
         * builder.addLabel("aus Liste entfernen", cc.xy(1, 23)); builder.add(button[2],
         * cc.xy(6, 23)); /* builder.addLabel("Vorlagenbezeichnung", cc.xy(1, 25));
         * builder.add(newdoc, cc.xyw(3, 25, 4)); builder.addLabel("Vorlage ausw�hlen",
         * cc.xy(1,27)); builder.addLabel("Dateiname", cc.xy(3,27,CellConstraints.RIGHT,
         * CellConstraints.BOTTOM)); builder.add(button[3], cc.xy(6,27));
         */
        /*
         * builder.addLabel("zu Liste hinzufügen", cc.xy(1, 29)); builder.add(button[4],
         * cc.xy(6, 29));
         */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        for (int i = 0; i < 1; i++) {
            /*
             * if (cmd.equals("entfernenvorlage")) { int row = vorlagen.getSelectedRow();
             ...
             * TableTool.loescheRow(vorlagen, row); } break; } if (cmd.equals("neuvorlage"))
             * { setCursor(Cursors.wartenCursor); String svorlage =
             * dateiDialog(Path.Instance.getProghome() + "vorlagen/" + Reha.getAktIK()); if
             * (svorlage.equals("")) { return; }
             * 
             * Vector vec = new Vector(); vec.add(""); vec.add(svorlage);
             * modvorlagen.addRow((Vector) vec.clone()); vorlagen.validate(); int rows =
             * modvorlagen.getRowCount(); final int xrows = rows - 1;
             * SwingUtilities.invokeLater(new Runnable() {
             * 
             * @Override public void run() { vorlagen.requestFocus();
             * vorlagen.setRowSelectionInterval(xrows, xrows); startCellEditing(vorlagen,
             * xrows); } }); break; }
             */
...
//      INIFile inif = INITool.openIni(Path.Instance.getProghome() + "ini/" + Reha.getAktIK() + "/", "kasse.ini");
         ...
         * formok = true; inif.setStringProperty("Formulare", "KassenFormulareAnzahl",
         * Integer.valueOf(rows) .toString(), null); } } if (formok) { for (int i = 0; i
         * < rows; i++) { inif.setStringProperty("Formulare", "KFormularText" + (i + 1),
         * (String) vorlagen.getValueAt(i, 0), null);
         * inif.setStringProperty("Formulare", "KFormularName" + (i + 1), (String)
     ...
     * Object value; JComponent component = new JFormattedTextField();
     * 
     * public TitelEditor() { // component = new JRtaTextField("NIX",true); //
     * System.out.println("editor-Component wurde initialisiert");
     * component.addKeyListener(new KeyAdapter() {
     * 
     * @Override public void keyPressed(KeyEvent arg0) { //
     * System.out.println("********Button in KeyPressed*********"); if
     * (arg0.getKeyCode() == KeyEvent.VK_ENTER) { arg0.consume(); stopCellEditing();
     * } } }); }
     * 
     * @Override public Component getTableCellEditorComponent(JTable table, Object
     * value, boolean isSelected, int row, int column) { ((JFormattedTextField)
     * component).setText((String) value); ((JFormattedTextField)
     * component).setCaretPosition(0); return component; }
     * 
     * @Override public Object getCellEditorValue() {
     * 
     * return ((JFormattedTextField) component).getText(); }
     * 
     * @Override public boolean isCellEditable(EventObject anEvent) { if (anEvent
     * instanceof MouseEvent) { MouseEvent me = (MouseEvent) anEvent; if
     * (me.getClickCount() != 2) { return false; } } //
     * System.out.println("isCellEditable"); return true; }
     * 
     * @Override public boolean shouldSelectCell(EventObject anEvent) { //
     * System.out.println("in schouldCellSelect"+anEvent); return
     * super.shouldSelectCell(anEvent); }
     * 
     * @Override public boolean stopCellEditing() { value = ((JFormattedTextField)
     * component).getText(); // System.out.println("in stopCellediting");
     * super.stopCellEditing(); return true; }
     * 
     * public boolean startCellEditing() { return false;//
     * super.startCellEditing();//false; }
     * 
     * }
     */
    @Override
