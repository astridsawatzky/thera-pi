...
/*
        ...
        /*
         * builder.addLabel("Vorlagenbezeichnung", cc.xy(1, 25)); builder.add(newdoc,
         * cc.xyw(3, 25, 4)); builder.addLabel("Vorlage ausw�hlen", cc.xy(1,27));
...
/*
        ...
        for (int i = 0; i < rows; i++) {
            ...
            if (test.equals("")) {
                ...
                formok = true;
                inif.setStringProperty("Formulare", "KassenFormulareAnzahl", Integer.valueOf(rows)
                                                                                    .toString(),
                        null);
            }
        }
        if (formok) {
            for (int i = 0; i < rows; i++) {
                inif.setStringProperty("Formulare", "KFormularText" + (i + 1), (String) vorlagen.getValueAt(i, 0),
                        null);
                inif.setStringProperty("Formulare", "KFormularName" + (i + 1), (String) vorlagen.getValueAt(i, 1),
                        null);
            }
        }
 */
