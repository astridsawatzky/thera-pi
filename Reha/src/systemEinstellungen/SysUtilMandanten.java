...
public class SysUtilMandanten extends JXPanel implements KeyListener, ActionListener, FocusListener {
    ...
    */
    ...
    String[] laender = { "Baden-Württemberg", "Bayern", "Berlin", "Brandenburg", "Bremen", "Hamburg", "Hessen",
    ...
    JRtaTextField[] tfield = { null, null, null, null, null, null, null, null, null, null, null, null, null, null, null,
    ...
    private JPanel knopfpanel() {
        ...
        // builder.addLabel("Mandantenauswahl bei Programmstart zeigen", cc.xyw(1, 3,
        // 9));
        builder.add(bootman, cc.xyw(1, 3, 9));
        // builder.addLabel("Mandant ist beim Programmstart vorausgew�hlt", cc.xyw(1, 5,
        // 9));
    ...
    private JPanel getVorlagenSeite() {
        ...
        for (int i = 0; i < SystemConfig.Mandanten.size(); i++) {
            String slabel = SystemConfig.Mandanten.get(i)[0] + " - " + SystemConfig.Mandanten.get(i)[1];
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand()
            ...
            if (!lneu) {
                ...
                // JOptionPane.showMessageDialog(null,"Der neue Mandant wird nun angelegt und
                // gespeichert");
                neuSpeichern();
            }
        ...
        if (e.getActionCommand()
            ...
            int anfrage = JOptionPane.showConfirmDialog(null, "Wollen Sie den eingestellten Mandanten wirklich löschen",
    ...
    private void neuSpeichern() {
        ...
        if (defman.isSelected()) {
            ...
            inif.setStringProperty("TheraPiMandanten", "DefaultMandant", Integer.valueOf(AnzahlMandanten)
                                                                                .toString(),
                    null);
        } else {
            inif.setStringProperty("TheraPiMandanten", "AuswahlImmerZeigen", "0", null);
        }
        // JOptionPane.showMessageDialog(null,"Es sind nun ingsgesamt - " +
        // AnzahlMandanten + " - gespeichert");
         ...
         * "dfue='1',mandant='"+neuik+"'"; SqlInfo.sqlAusfuehren(cmd);
         */
        // String cmd = "insert into nummern set mandant='"+neuik+"'";
        // new ExUndHop().setzeStatement(cmd);
        JOptionPane.showMessageDialog(null,
                "<html>Der neue Mandant wurde gespeichert<br><br><b>Ordnen Sie nun bitte dem neuen Mandanten eine Datenbankverbindung zu!</b><br></html>");
    }
    ...
    private void felderAufNull() {
        String[] stitel = { "Ik", "Ikbezeichnung", "Firma1", "Firma2", "Anrede", "Nachname", "Vorname", "Strasse",
                ...
                "Logodatei", "Zusatz1", "Zusatz2", "Zusatz3", "Zusatz4" };
    ...
    /*
     * String verz= ""; try{ VerzErst uebergabe = new VerzErst(); verz =
     * uebergabe.eingeben(); File verzeichnis = new File(verz);
     * verzeichnis.mkdirs(); } catch (Exception e){ //System.out.println (
     * "Fehler: " +e.getMessage()); } }//Ende erstellen
     * 
     * File f = new File(PfadZumVerzeichnis) f.delete()
     */
    ...
    protected Integer doInBackground() throws Exception {
        try {
            ...
            String[] stitel = { "Ik", "Ikbezeichnung", "Firma1", "Firma2", "Anrede", "Nachname", "Vorname", "Strasse",
                    ...
                    "Hrb", "Logodatei", "Zusatz1", "Zusatz2", "Zusatz3", "Zusatz4" };

            for (int i = 0; i < stitel.length; i++) {
                ifile.setStringProperty("Firma", stitel[i], SysUtilMandanten.thisClass.tfield[i].getText()
                                                                                                .trim(),
                        null);
            }
            ifile.setStringProperty("Firma", "Bundesland",
                    ((String) SysUtilMandanten.thisClass.bula.getSelectedItem()).trim(), null);
            // ifile = null;
            INITool.saveIni(ifile);
