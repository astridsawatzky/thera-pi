...
public class SysUtilBedienung extends JXPanel implements KeyListener, ActionListener {
     ...
     * 
     * tfs[0].setText((Boolean)SystemConfig.hmPatientenWerkzeugDlgIni.get(
     * "ToolsDlgShowButton") ? "1" : "0");
     * tfs[1].setText(SystemConfig.hmPatientenWerkzeugDlgIni.get(
     * "ToolsDlgClickCount").toString());
     * 
    ...
    private JPanel getVorlagenSeite() {
        ...
        JLabel lab3 = new JLabel(
                "<html><b>Werkzeug-Dialoge <font color=#0000FF>(Benutzer individuelle Einstellung)</font></b></html>");
...
//		builder.add(tfs[0],cc.xy(3,iAktY));
        ...
        cmbBut.setSelectedItem(tfs[0].getText()
...
//		builder.addLabel("(1, 2)",cc.xy(5,iAktY));
        ...
        tfs[1].setText(SystemConfig.hmPatientenWerkzeugDlgIni.get("ToolsDlgClickCount")
                                                             .toString());
//		builder.add(tfs[1],cc.xy(3,iAktY));
        ...
        cmbClk.setSelectedItem(tfs[1].getText()
                                     .equals("1") ? "1 Klick" : "2 Klicks"); // setze den aktuell gewählten Wert
        ...
        JLabel lab4 = new JLabel(
                "<html><b>Rezept-Dialog <font color=#0000FF>(Benutzer individuelle Einstellung)</font></b></html>");
...
//		vecJN.add(1,(Vector<String>) vec.clone());
        ...
        cmbRezAbbruch.setSelectedItem(tfs[2].getText()
                                            .equals("0") ? "Nein" : "Ja"); // setze den aktuell gewählten Wert
        ...
        // JOptionPane.showMessageDialog(null, "aktuelle Y-Position im Layout =
        // "+iAktY);
        iAktY += 2;
        lab3 = new JLabel(
                "<html><b>Heilmittel-Dialog <font color=#0000FF>(Benutzer individuelle Einstellung)</font></b></html>");
        builder.add(lab3, cc.xyw(1, iAktY, 11));
        iAktY += 2;
        ...
        cmbShowHmDlg.setSelectedItem(tfs[3].getText()
                                           .equals("0") ? "Nein" : "Ja"); // setze den aktuell gewählten Wert
        ...
        cmbShowDiffOnly.setSelectedItem(tfs[5].getText()
                                              .equals("0") ? "Nein" : "Ja"); // setze den aktuell gewählten Wert
        ...
        iAktY += 2;
        lab3 = new JLabel(
                "<html><b>Arbeitsflächen <font color=#0000FF>(Benutzer individuelle Einstellung)</font></b></html>");
        builder.add(lab3, cc.xyw(1, iAktY, 11));
        iAktY += 2;
        ...
        cmbDesktop.setSelectedItem(tfs[4].getText()
                                         .equals("1") ? "horizontal" : "vertikal"); // setze den aktuell gewählten Wert
        ...
        // Trennlinie mit Leerzeilen
        /*
         * iAktY += 2; builder.addLabel(" ",cc.xyw(1, iAktY, 11));
         * //---------------------------------------------------------------------------
         * ---- iAktY += 1; builder.addSeparator("", cc.xyw(1,iAktY,11)); iAktY += 1;
         * builder.addLabel(" ",cc.xyw(1, iAktY, 11));
         */
...
//			System.out.println("cmbClk.getSecValue() = " + cmbClk.getSecValue());
    ...
    private void doSpeichern() {
        ...
        SystemConfig.hmPatientenWerkzeugDlgIni.put("ToolsDlgShowButton", tfs[0].getText()
                                                                               .equals("1") ? true : false);
...
//		inif.setIntegerProperty("Bedienung", "WerkzeugaufrufButtonZeigen", (Boolean)SystemConfig.hmPatientenWerkzeugDlgIni.get("ToolsDlgShowButton") ? 1 : 0, " Zusatzknopf im Werkzeugdialog");
        ...
        // Lemmi 20110116: Abfrage Abbruch bei Rezeptänderungen mit Warnung
        SystemConfig.hmRezeptDlgIni.put("RezAendAbbruchWarn", tfs[2].getText()
                                                                    .equals("1") ? true : false);
        // HeilmittelDialog bei Terminbestätigen zeigen falls notwendig /st.
        SystemConfig.hmTerminBestaetigen.put("dlgzeigen", tfs[3].getText()
                                                                .equals("1") ? true : false);
        SystemConfig.hmTerminBestaetigen.put("dlgdiffzeigen", tfs[5].getText()
                                                                    .equals("1") ? true : false);

        SystemConfig.desktopHorizontal = (tfs[4].getText()
                                                .equals("1") ? true : false);
