...
public class SysUtilAnschluesse extends JXPanel implements KeyListener, ActionListener {
    ...
    private JPanel getVorlagenSeite() {
        ...
        anschluss = new JComboBox(new String[] { "COM 1", "COM 2", "COM 3", "COM 4", "COM 5", "COM 6", "COM 7", "COM 8",
                "COM 9", "COM 10" });
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("anschluss")) {
            doConfig("COM" + Integer.valueOf(anschluss.getSelectedIndex() + 1)
                                    .toString());
        }
        if (cmd.equals("speichern")) {
            doSpeichern("COM" + Integer.valueOf(anschluss.getSelectedIndex() + 1)
                                       .toString());
        }
    ...
    private void doSpeichern(String com) {
        ...
        JOptionPane.showMessageDialog(null,
                "Anschlußkonfiguration wurde gespeichert und steht nach dem nächsten\nStart der Software zur Verfügung");
    }
