...
public class SysUtilGeraete extends JXPanel implements KeyListener, ActionListener {
    ...
    String[] anschluesse = new String[] { "./.", "COM1", "COM2", "COM3", "COM4", "COM5", "COM6", "COM7", "COM8", "COM9",
            "COM10", "USB" };
    Scanner scanner;
    ...
    private JPanel getVorlagenSeite() {
        ...
        docscanakt.setSelected((SystemConfig.hmDokuScanner.get("aktivieren")
                                                          .equals("1") ? true : false));
    ...
    private void readerTest() {
        ...
        // Routine eingebaut werden die überprüft ob die angegebene .dll bzw. .so
        // überhaupt existiert.
        try {
            ...
            int antwort = JOptionPane.showConfirmDialog(null, "Bitte KV-Karte einlegen und ok. drücken",
                    "Vorbereitung für Reader-Test", JOptionPane.OK_CANCEL_OPTION);
    ...
    private void doSpeichern() {
        ...
        SystemConfig.sBarcodeScanner = (barcodegeraet.getSelectedItem() == null ? ""
                : (String) barcodegeraet.getSelectedItem());
        ...
        inif.setStringProperty("DokumentenScanner", "DokumentenScannerAktivieren",
                (docscanakt.isSelected() ? "1" : "0"), null);

        SystemConfig.sDokuScanner = (docscangeraet.getSelectedItem() == null ? ""
                : (String) docscangeraet.getSelectedItem());
        ...
        JOptionPane.showMessageDialog(null,
                "Gerätekonfiguration wurde erfolgrich gespeichert und steht nach dem nächsten\nStart der Software zur Verfügung");
    }
}
