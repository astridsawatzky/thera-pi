...
public class Lieferant {
    ...
    public Lieferant(String name, String ansprechpartner, String anschrift, String plz, String ort, String telefon,
            String telefax) {
        this.name = name;
        ...
        String sql = "INSERT INTO verklieferant (verklieferantID, name, ansprechpartner, anschrift, plz, ort, telefon, telefax) "
                + "VALUES (NULL, '" + this.name + "', '" + this.ansprechpartner + "', '" + this.anschrift + "', '"
                + this.plz + "', '" + this.ort + "', '" + this.telefon + "', '" + this.telefax + "');";
        SqlInfo.sqlAusfuehren(sql);
    }

    private void update() {
        String sql = "UPDATE verklieferant SET name = '" + this.name + "', " + "ansprechpartner = '"
                + this.ansprechpartner + "', " + "anschrift = '" + this.anschrift + "', " + "plz = '" + this.plz + "', "
                + "ort = '" + this.ort + "', " + "telefon = '" + this.telefon + "', " + "telefax = '" + this.telefax
                + "' WHERE verklieferantID = " + this.id + ";";
        SqlInfo.sqlAusfuehren(sql);
    }
    ...
    public static Vector<Vector<String>> sucheLieferantenDaten(String suche) {
        String sql = "SELECT name, ansprechpartner, telefon, telefax, anschrift, plz, ort, verklieferantID FROM verklieferant WHERE name LIKE '%"
                + suche + "%' OR ansprechpartner LIKE '%" + suche + "%' " + "OR telefon LIKE '%" + suche
                + "%' OR telefax LIKE '%" + suche + "%';";
        Vector<Vector<String>> lieferanten = SqlInfo.holeFelder(sql);
        return lieferanten;
    }
