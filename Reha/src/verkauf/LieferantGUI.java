    ...
    public void aktiviereFunktion(int befehl) {
        if (befehl == VerkaufTab.neu) {
            ...
            if (this.lftab.getSelectedRow() >= 0) {
                this.doLieferantDialog(Integer.parseInt((String) this.lfmod.getValueAt(this.lftab.getSelectedRow(), 7)),
                        this.owner.holePosition(300, 300));
                this.setzeTabDaten(Lieferant.liefereLieferantenDaten());
                this.setLastRowSelected();
            } else {
