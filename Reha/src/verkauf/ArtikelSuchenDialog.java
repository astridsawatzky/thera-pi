...
public class ArtikelSuchenDialog extends RehaSmartDialog {
     ...
     * 
     * panel.setTitle("Aritkel suchen"); panel.setTitleForeground(Color.white);
        ...
        kl = new KeyListener() {
            ...
            public void keyPressed(KeyEvent arg0) {
                if (arg0.getSource() instanceof JRtaTextField) {
                    ...
                    if (arg0.getKeyCode() == KeyEvent.VK_ENTER) {
                        schliessen(true);
                    } else if ((arg0.getKeyCode() == KeyEvent.VK_A) && arg0.isAltDown()) {
                        suche.requestFocus();
                    } else if (arg0.getKeyCode() == KeyEvent.VK_ESCAPE) {
                        schliessen(false);
                    }
    ...
    private void holeDaten() {
         ...
         * spaltenNamen.add("Artikel-ID"); spaltenNamen.add("Beschreibung");
    ...
    private void schliessen(boolean eansetzen) {
        ...
        // ungünstig, da ein Artikel übergeben wird sobald eine Tabellenzeile selektiert
        // ist,
