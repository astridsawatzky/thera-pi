...
public class SMS {
    ...
    public static void main(String args[]) {
        ...
        try {
            // phone=URLEncoder.encode("http://t-online.t-online.de/t-on/dien/sms/star/CP/start.html",
            // "UTF-8");
        ...
        String url_str = ppgHost + "?user=" + username + "&password=" + password + "&PhoneNumber=" + phone + "&text="
                + message;
