...
public class BegleitzettelDrucken {
    ...
    public BegleitzettelDrucken(AbrechnungGKV eltern, int anzahlRezepte, String kostentrIK, String kostentrName,
        ...
        if (SystemConfig.hmAbrechnung.get("hmallinoffice")
            ...
            try {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null,
                            "Fehler im Modul isActivePrinterBusy() Begleitzettl\n" + ex.getMessage());
                }
            } catch (Exception ex) {
            ...
            if (placeholders[i].getDisplayText()
                ...
                placeholders[i].getTextRange()
                               .setText(this.kostentrName);
                                      ...
                                      .equals("<gkv7>")) {
                placeholders[i].getTextRange()
                               .setText(SystemConfig.hmFirmenDaten.get("Firma1") + " "
                ...
                if (this.anzahlRezepte == 1) {
                    placeholders[i].getTextRange()
                                   .setText(Integer.toString(this.anzahlRezepte) + " Originalrezept");
                } else {
                    placeholders[i].getTextRange()
                                   .setText(Integer.toString(this.anzahlRezepte) + " Originalrezepte");
                }
            }
        }
    }
