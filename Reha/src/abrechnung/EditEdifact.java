...
public class EditEdifact extends JXDialog
    ...
    private JXPanel getEdifact() {
        ...
        new SwingWorker<Void, Void>() {
            ...
            protected Void doInBackground() throws Exception {
                area.setText(
                        SqlInfo.holeEinzelFeld("select edifact from fertige where rez_nr ='" + reznr + "' LIMIT 1"));
                return null;
            }
        }.execute();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("ok")) {
            SqlInfo.sqlAusfuehren("update fertige set edifact='" + StringTools.Escaped(area.getText())
