...
public class KasseNeuanlage extends JXPanel implements ActionListener, KeyListener, FocusListener {
    ...
    private void doVergleichKT() {
        ...
        if (neuAnlage == true || jtf[13].getText()
                                        .trim()
                                        .equals("")) {
            /*
             * JRtaTextField f = new JRtaTextField("ZAHLEN",true); f.setColumns(9); Object[]
             * message={"<html>Krankenkassennummer laut Rezept<br>" +
             * "bitte <b>7-stellige</b> Zahl eingeben</html>", f}; Object[] options={"OK",
             * "Cancel"}; JOptionPane.showOptionDialog(null, message, "KV-Nummer eingeben",
             * JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, options,
             * f); kVNummer.setText(f.getText());
             */
    ...
    public void focusGained(FocusEvent arg0) {
        ...
        if (((JComponent) arg0.getSource()).getName()
            ...
            if (this.neuAnlage && (!jtf[0].getText()
                                          .trim()
                                          .equals("-"))) {
    ...
    public void ktraegerAuslesen() {
         ...
         * mlaChecker.setVisible(true); ((JDialog)this.eltern).toFront();
         */
    ...
    public void tabelleAktualisieren() {
        ...
        List<String> list = Arrays.asList(new String[] { jtf[0].getText(), jtf[2].getText(), jtf[3].getText(),
                jtf[6].getText(), jtf[7].getText(), jtf[8].getText(), jtf[13].getText(), this.kassenId });
        if (this.neuAnlage) {
    ...
    private JXPanel getDatenPanel() {
        ...
        /*
         * // 1. 2. 3. 4. 5. 6. FormLayout lay = new
         * FormLayout("right:max(80dlu;p), 4dlu, 60dlu,right:max(60dlu;p), 4dlu, 60dlu",
