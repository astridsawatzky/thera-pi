...
public class JRehaInternal extends JInternalFrame implements ActionListener,ComponentListener,KeyListener,MouseListener,MouseMotionListener,InternalFrameListener,AncestorListener{
	...
	private JPopupMenu getTerminPopupMenu() {
		...
		jmen.setIcon((this.desktop==0 ? new ImageIcon(Path.Instance.getProghome()+(SystemConfig.desktopHorizontal ? "/icons/unten.gif" : "/icons/forward.gif")) :
			new ImageIcon(Path.Instance.getProghome()+(SystemConfig.desktopHorizontal ? "/icons/oben.gif" : "/icons/backward.gif"))));
