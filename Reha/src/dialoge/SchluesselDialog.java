...
public class SchluesselDialog extends JDialog implements WindowListener {
    ...
    private JPanel getSchluessel() {
        ...
        FormLayout lay = new FormLayout("0dlu,right:max(40dlu;p),10dlu,120dlu,50dlu",
                "10dlu,p,10dlu,p,10dlu,p,10dlu,p,10dlu");
    ...
    private void testeSchluessel() {
        Vector<String> vec = SqlInfo.holeSatz("anwesend", " * ", "schrank ='" + schluessel + "'",
        ...
        if (ausgabe) {
            ...
            new SwingWorker<Void, Void>() {
                ...
                protected Void doInBackground() throws Exception {
                    ...
                    String cmd = "insert into anwesend set nname='" + tfs[0].getText() + "', datum='"
                            + DatFunk.sDatInSQL(DatFunk.sHeute()) + "', " + "kommen='" + clockFormat.format(new Date())
                            + "', schrank='" + schluessel + "', pfand='" + tfs[1].getText() + "'";
