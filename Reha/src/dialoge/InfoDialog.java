        ...
        if (tage.size() == Integer.parseInt(vecResult.get(0)
            ...
            if ((diff = DatFunk.TageDifferenz(DatFunk.sDatInDeutsch(vecResult.get(0)
                ...
                ergebnis.append("<span " + getSpanStyle("14", "#ff0000") + "<b>"
                        ...
                        + "Achtung Behandlungsbeginn heute überschreitet<br>den spätestesn Behandlungsbeginn<br>um "
    ...
    final class SuchenInTagen extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                while (!muststop) {
                    try {
                        rs = stmt.executeQuery("select * from flexkc where datum = '" + DatFunk.sDatInSQL(anzeigedatum)
