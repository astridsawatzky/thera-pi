...
public class NachsorgePDF {
    ...
    private boolean doSeite2(boolean vorschau, String ausfertigung, String bereich) {
        ...
        try {
            ...
            for (int i = 0; i < 1; i++) {
                ...
                ct.setSimpleColumn(rechneX(28.5f), rechneY(112.f), rechneX(190.0f), rechneY(162.f), 8.25f,
                ...
                /*
                 * Float[][] poswert1 =
                 * {getFloats(28.45f,90.35f,fy1),getFloats(69.25f,90.35f,fy1),getFloats(124.05f,
                 * 90.35f,fy1),getFloats(159.8f,90.35f,fy1),
                 * getFloats(28.45f,82.25f,fy1),getFloats(28.45f,74.25f,fy1) };
                 */
                Float[][] poswert1 = { getFloats(28.45f, 90.35f, fy1), getFloats(28.45f, 82.25f, fy1),
                        getFloats(28.45f, 74.25f, fy1), getFloats(69.25f, 90.35f, fy1), getFloats(69.25f, 82.25f, fy1),
                        getFloats(69.25f, 74.25f, fy1), getFloats(124.05f, 90.35f, fy1),
                        getFloats(124.05f, 82.25f, fy1), getFloats(124.05f, 74.25f, fy1),
                        getFloats(159.8f, 90.35f, fy1), getFloats(159.8f, 82.25f, fy1),
                        getFloats(159.8f, 74.25f, fy1) };
                bf = BaseFont.createFont(BaseFont.HELVETICA, BaseFont.CP1250, BaseFont.EMBEDDED/* NOT_EMBEDDED */);
                for (i = 7; i < 19; i++) {
                    setzeText(cb, poswert1[i - 7][0], poswert1[i - 7][1], poswert1[i - 7][2], bf, 12,
                            (eltern.bchb[i].isSelected() ? "X" : ""));
                }
                // Erl�uterungen der CheckBox-Auswahl
                cb.setCharacterSpacing(0.25f);
                ct = new ColumnText(cb);
                ct.setSimpleColumn(rechneX(28.5f), rechneY(60.f), rechneX(190.0f), rechneY(69.f), 8.25f,
                        Element.ALIGN_BOTTOM);
                ph = new Phrase();
                ph.setFont(FontFactory.getFont("Courier", 9, Font.PLAIN));
                ph.add(eltern.bta[8].getText()
                                    .trim());
                ct.addText(ph);
                ct.go();
                // Letzte Medikation
                cb.setCharacterSpacing(0.25f);
                ct = new ColumnText(cb);
                ct.setSimpleColumn(rechneX(28.5f), rechneY(44.f), rechneX(190.0f), rechneY(54.0f), 8.25f,
                        Element.ALIGN_BOTTOM);
                ph = new Phrase();
                ph.setFont(FontFactory.getFont("Courier", 9, Font.PLAIN));
                ph.add(eltern.bta[9].getText()
                                    .trim());
                ct.addText(ph);
                ct.go();
                // Ort und Datum
                bf = BaseFont.createFont(BaseFont.COURIER, BaseFont.CP1250, BaseFont.EMBEDDED/* NOT_EMBEDDED */);
                String text = eltern.btf[23].getText()
                                            .trim();
    ...
    private boolean doSeite1(boolean vorschau, String ausfertigung, String bereich) {
        ...
        try {
            ...
            Float[][] poswert1 = { getFloats(29.f, 268.25f - 15.0f, fy1),
                    ...
                    getFloats(103.30f, 268.25f - 15.0f, fy1), getFloats(29.f, 260.0f - 14.75f, fy0),
                    getFloats(29.0f, 251.5f - 14.15f, fy1),
                    // 4Strasse 5PLZ 6Ort
                    getFloats(29.f, 243.0f - 13.65f, fy0), getFloats(29.f, 234.5f - 13.25f, fy1),
                    getFloats(52.5f, 234.5f - 13.25f, fy0),
                    // 7VersichertenName 8MSNR 9BNR
                    getFloats(29.f, 226.0f - 12.95f, fy0), getFloats(131.25f - 7.f, 268.25f - 15.0f, fy1),
                    getFloats(156.25f - 3.25f, 268.25f - 15.0f, fy1) };
            ...
            for (int i = 11; i < 23; i++) {
                if (i == 11 || i == 12 || i == 20) {
                    setzeText(cb, poswert1[i - 11][0], poswert1[i - 11][1], poswert1[i - 11][2], bf, 12,
                            this.macheDatum2Sechs(eltern.btf[i].getText()));
                    // setzeText(cb,poswert1[i-11][0],
                    // poswert1[i-11][1],poswert1[i-11][2],bf,12,this.macheDatum2Sechs(eltern.btf[i].getText()));
                } else if (i == 21 || i == 22) {
                    if (!eltern.btf[i].getText()
                                      .trim()
                                      .equals(".  .")) {
                        setzeText(cb, poswert1[i - 11][0], poswert1[i - 11][1], poswert1[i - 11][2], bf, 12,
                                eltern.btf[i].getText());
                    }
                } else {
                    setzeText(cb, poswert1[i - 11][0], poswert1[i - 11][1], poswert1[i - 11][2], bf, 12,
                            eltern.btf[i].getText());
            ...
            poswert1 = new Float[][] { getFloats(141.05f, 178.5f - 0.75f, fy1), getFloats(152.80f, 178.5f - 0.75f, fy1),
                    getFloats(164.65f, 178.5f - 0.75f, fy1),
                    // Seite 2 Sicherheit 2 Beh.Ergebnis 2
                    getFloats(141.05f, 166.65f - 0.75f, fy1), getFloats(152.80f, 166.65f - 0.75f, fy1),
                    getFloats(164.65f, 166.65f - 0.75f, fy1),
                    // Seite 3 Sicherheit 3 Beh.Ergebnis 3
                    getFloats(141.05f, 154.80f - 0.75f, fy1), getFloats(152.80f, 154.80f - 0.75f, fy1),
                    getFloats(164.65f, 154.80f - 0.75f, fy1),
                    // Seite 4 Sicherheit 4 Beh.Ergebnis 4
                    getFloats(141.05f, 142.75f - 0.75f, fy1), getFloats(152.80f, 142.75f - 0.75f, fy1),
                    getFloats(164.65f, 142.75f - 0.75f, fy1),
                    // Seite 5 Sicherheit 5 Beh.Ergebnis 5
                    getFloats(141.05f, 131.0f - 0.75f, fy1), getFloats(152.80f, 131.0f - 0.75f, fy1),
                    getFloats(164.65f, 131.0f - 0.75f, fy1), };
            for (int i = 0; i < 15; i++) {
                setzeText(cb, poswert1[i][0], poswert1[i][1], poswert1[i][2], bf, 12,
                        (String) eltern.bcmb[i].getSelectedItem());
            }
            // Die Check-Boxen
            ...
            /*
             * float xstart = 82.f; float xend = 282.f; float ystartunten = 495.f; float
             * ystartoben = 530.f; float yschritt = 35.f;
             */
            ...
            for (int i = 0; i < 5; i++) {
                 ...
                 * chunk.setFont(FontFactory.getFont("Courier",9,Font.PLAIN)); ct = new
                 * ColumnText(cb); ct.addText(chunk); ct.setSimpleColumn(xstart,
                 * ystartunten,xend,ystartoben,8,Element.ALIGN_BOTTOM); ct.go(); //float
                 * yAbsolutePosition = iTextDoc.bottomMargin() +
                 * iTextPdfPTable.getTotalHeight(); //iTextPdfPTable.writeSelectedRows(0, -1,
                 * iTextDoc.leftMargin(), yAbsolutePosition, pdfWriter.getDirectContent());
                 */
            ...
            // PDFTools.FliessText(rechneX(29.f), rechneY(48.f),
            // rechneX(160.0f),rechneY(76.f), cb, eltern.bta[6].getText().trim(),stamper);
    ...
    private void schreibeEmpfaenger(PdfContentByte cb, String empfaenger) throws DocumentException, IOException {
        ...
        BaseFont bf = BaseFont.createFont(BaseFont.HELVETICA_BOLD, BaseFont.CP1250,
                BaseFont.EMBEDDED/* .NOT_EMBEDDED */);
        cb.beginText();
