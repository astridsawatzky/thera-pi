...
public class NeuerMandant implements KeyListener, ActionListener, FocusListener {
    ...
    private JXPanel getForm() {
        ...
        FormLayout layout = new FormLayout("10dlu,right:max(20dlu;p),2dlu,100dlu,10dlu,p,2dlu,p,100dlu",
        ...
        layout = new FormLayout("35dlu,p,25dlu,p,50dlu,p", "5dlu,p,10dlu,p,3dlu,p,3dlu,p,15dlu,p");
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (e.getKeyCode() == 10) {
            ...
            SysUtilMandanten.thisClass.neuik = jrtaf[1].getText()
                                                       .trim();
            SysUtilMandanten.thisClass.neuname = jrtaf[0].getText()
                                                         .trim();
            rSmart.dispose();
        }
        if (e.getKeyCode() == 27) {
