...
public class TbEingabeNeu extends JXPanel implements ActionListener, KeyListener, FocusListener {
    ...
    private void machText() {
        ...
        /****************************/
        /*
         * if(varvec.get(aktvector).contains("^CRLF^") ){ int i = aktvector; while(i <=
         * maxvector){ if( (!varvec.get(i).contains("^CRLF^")) ){ break; } i++; } if(i >
         * maxvector){ werteUebergeben();
         * ////System.out.println("nach der while schleife");
         * this.thbl.wechsleRueckwaerts(); return; } aktvector = i; }
         */
        /*****************************/
        this.savetext = this.savetext.replace(aktreplace, "<b><font color='#000000'>" + tbeingabe.getText()
                                                                                                 .trim()
                + "</font></b>");
        ...
        /**********************/
        /*
         * while(i <= maxvector){ if( (!varvec.get(i).contains("^CRLF^")) ){ break; }
         * i++; }
         */
        /**********************/
        // 2,
