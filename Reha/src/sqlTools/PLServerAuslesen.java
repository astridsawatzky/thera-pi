...
public class PLServerAuslesen {
    ...
    public boolean oeffnePLConnection() {
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:jpmdbc:http://www.thera-pi.org/jpmdbc.php?db336243054",
                    connProperties);

            Date zeit = new Date();
            String stx = "Insert into eingeloggt set comp='" + "Preis-Listen " + java.net.InetAddress.getLocalHost()
                    + ": import" + "', zeit='" + zeit.toString() + "', einaus='ein';";
            sqlAusfuehren(stx);
