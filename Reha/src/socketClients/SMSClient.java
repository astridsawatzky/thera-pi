...
public class SMSClient {
    ...
    private void serverStarten() throws IOException, ConnectException {
        ...
        /*
         * this.server = new Socket(); SocketAddress sockaddr = new
         * InetSocketAddress(SystemConfig.hmSMS.get("IP"),Integer.parseInt(SystemConfig.
         * hmSMS.get("PORT"))); this.server.connect(sockaddr, 2000);
         */
