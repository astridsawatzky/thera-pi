...
public class AkutListe{
			...
			for(int i = 0; i < lang;i++){
				  try {
					  ...
					  */
					  ...
					  textTable.getCell(0,i+1).getTextService().getText().setText(result);

					  result = (String) ((Vector<?>)vec.get(i)).get(1)+"\r"+ (String)((Vector<?>)vec.get(i)).get(2);
					  textTable.getCell(1,i+1).getTextService().getText().setText(result);

					  result = "";
					  test = (String) ((Vector<?>)vec.get(i)).get(3);
					  result = result + (test.trim().equals("") ? "" : "p:"+test);
					  test = (String) ((Vector<?>)vec.get(i)).get(4);
					  result = result + (test.trim().equals("") ? "" : "\r"+"g:"+test);
					  test = (String) ((Vector<?>)vec.get(i)).get(5);
					  result = result + (test.trim().equals("") ? "" : "\r"+"m:"+test);
					  test = (String) ((Vector<?>)vec.get(i)).get(6);
					  result = result + (test.trim().equals("") ? "" : "\r"+"e:"+test);
					  textTable.getCell(2,i+1).getTextService().getText().setText(result);
					  ...
					  result = result + test;
					  textTable.getCell(3,i+1).getTextService().getText().setText(result);

					  result = "";
					  test = (String) ((Vector<?>)vec.get(i)).get(7);
					  result = result + (test.trim().equals("") ? "" : test);
					  test = (String) ((Vector<?>)vec.get(i)).get(8);
					  result = result + (test.trim().equals("") ? "" : "\r"+test);
					  textTable.getCell(4,i+1).getTextService().getText().setText(result);
    ...
    private void formatCharacter(ITextTable textTable, int column, int row) throws TextException {
        textTable.getCell(column, row).getCharacterProperties().setFontName("Courier New");
        textTable.getCell(column, row).getCharacterProperties().setFontSize(10.f);
        textTable.getCell(column, row).getCharacterProperties().setFontBold((row==0 ? true : false));
    }
    private void formatCharacter(ITextTable textTable, int column, int row, int color) throws TextException {
        ...
        textTable.getCell(column, row).getCharacterProperties().setFontColor(color);
    }
}