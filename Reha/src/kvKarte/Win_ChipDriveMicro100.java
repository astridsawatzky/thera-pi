...
public class Win_ChipDriveMicro100 {
    ...
    public String[] kartenAktion() {
        ...
        try {
            ret = lib.SCardComand(hwnd, sCommand, cmdLen, "", inLen, output, outLen);

            //// System.out.println("Rückgabewert der Funktion =
            //// "+Integer.valueOf(ret).toHexString(ret) );
    ...
    public String fehlerDeuten(int ibr, SCard32 lib) {
        ...
        // String str = null;
        /* int ibrx = */lib.SCardComand(hwnd, sCommand, cmdLen, "", inLen, output, outLen);
        String[] hmdaten = Native.toString(output)
                                 .split("\r\n");
    ...
    interface SCard32 extends StdCallLibrary {
        ...
        public int SCardComand(Pointer hwnd, String Cmd, Pointer CmdLen, String dataIn, Pointer dataInLen,
                byte[] dataOut, Pointer dataoutlen);

        /*
         * Original C-Deklaration LPINT Handle Zeiger auf einen 32 Bit signed integer
         * LPSTR Cmd Zeiger auf einen null terminierten String LPINT CmdLen Zeiger auf
         * einen 32 Bit signed integer LPSTR DataIn Zeiger auf ein array of byte oder
         * einen String LPINT DataInLen Zeiger auf einen 32 Bit signed integer LPSTR
         * DataOut Zeiger auf ein array of byte oder einen String LPINT DataOutLen
         * Zeiger auf einen 32 Bit signed integer INT Response 32 Bit signed integer
         */
