                    ...
                    */
                    if (e.getKeyCode() == 16) {
                        ...
                        if (!gruppierenAktiv) {
                            ...
                            gruppierenBehandler = (ansicht == NORMAL_ANSICHT ? belegung[aktiveSpalte[2]]
                                    : aktiveSpalte[2]);
        ...
        if (this.ansicht == NORMAL_ANSICHT) {
            ...
            if (behandler == 0) {
                behandler = ParameterLaden.vKKollegen.get(
                        ParameterLaden.suchen((String) oCombo[0].getSelectedItem())).Reihe;
            }
                ...
                try {
                    ...
                    if (vec.size() > 0) {
                        ...
                        Object[] objTerm = RezTools.BehandlungenAnalysieren(swreznum, false, xforceDlg, false,
                                ...
                                ParameterLaden.getKollegenUeberDBZeile(swbehandler + 1),
