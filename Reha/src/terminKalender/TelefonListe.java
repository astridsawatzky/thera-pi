...
public class TelefonListe {
    ...
    public TelefonListe(Object obj) throws TextException {
        ...
        for (int i = 0; i < ((Vector<?>) ((ArrayList<?>) obj).get(0)).size(); i++) {
            ...
            if (((String) ((Vector<?>) ((ArrayList<?>) obj).get(1)).get(i)).equals("")) {
                ...
                daten[1] = ((String) ((Vector<?>) ((ArrayList<?>) tfobj).get(0)).get(i))
                        + "\r\rKeine Zuordnung möglich!";
                daten[2] = "keine RezNr.";
                daten[4] = "???";
                dvec.add(daten);
                continue;
    ...
    private void testeReznr(String xreznr, int zaehler) {
        ...
        if (vec1.size() == 0) {
            ...
            daten[1] = ((String) ((Vector<?>) ((ArrayList<?>) tfobj).get(0)).get(zaehler))
                    + "\r\rKeine Zuordnung möglich, falsche Rezeptnummer???";
            daten[2] = xreznr;
            daten[4] = "???";
            dvec.add(daten);
            return;
        ...
        if (vec2.size() == 0) {
            daten[0] = ((String) ((Vector<?>) ((ArrayList<?>) tfobj).get(2)).get(zaehler)).substring(0, 5) + "Uhr";
            daten[1] = ((String) ((Vector<?>) ((ArrayList<?>) tfobj).get(0)).get(zaehler))
                    + "\r\rKeine Zuordnung möglich, Patient nicht gefunden";
            daten[2] = xreznr;
            daten[4] = "???";
        ...
        daten[2] = xreznr;
        String telefon = (vec2.get(2)
                              .trim()
                              .length() > 0 ? "p:" + (vec2.get(2)) : "");
        telefon = telefon + (vec2.get(3)
                                 .trim()
                                 .length() > 0 ? "\r" + "g:" + (vec2.get(3)) : "");
        telefon = telefon + (vec2.get(4)
                                 .trim()
                                 .length() > 0 ? "\r" + "m:" + (vec2.get(4)) : "");
        telefon = telefon + (vec2.get(5)
                                 .trim()
                                 .length() > 0 ? "\r" + "e:" + (vec2.get(5)) : "");
        daten[3] = telefon;
        daten[4] = (vec2.get(6)
                        .equals("T") ? "JA!!!!" : "nein");
        dvec.add(daten);
            ...
            for (int i = 0; i < lang; i++) {
                try {
                    textTable.getCell(0, i + 1)
                             .getTextService()
                             .getText()
                             .setText((((String[]) ((Vector<?>) dvec).get(i))[0]));
                    textTable.getCell(1, i + 1)
                             .getTextService()
                             .getText()
                             .setText((((String[]) ((Vector<?>) dvec).get(i))[1]));
                    textTable.getCell(2, i + 1)
                             .getTextService()
                             .getText()
                             .setText((((String[]) ((Vector<?>) dvec).get(i))[2]));
                    textTable.getCell(3, i + 1)
                             .getTextService()
                             .getText()
                             .setText((((String[]) ((Vector<?>) dvec).get(i))[3]));
                    textTable.getCell(4, i + 1)
                             .getTextService()
                             .getText()
                             .setText((((String[]) ((Vector<?>) dvec).get(i))[4]));
                    textTable.getCell(5, i + 1)
                             .getTextService()
                             .getText()
                             .setText("");
                } catch (TextException exception) {
