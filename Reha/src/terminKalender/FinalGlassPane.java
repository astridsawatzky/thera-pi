    ...
    public void eventDispatched(AWTEvent event) {
        ...
        if (event instanceof MouseEvent) {
            ...
            if (me.getID() == MouseEvent.MOUSE_EXITED && me.getComponent() == frame) {
                ...
                maxhoch = Integer.toString(me.getComponent()
                                             .getHeight());
                ...
                /*
                 * System.out.println("Minuten bis 07:00 = "+ZeitFunk.MinutenSeitMitternacht(
                 * SystemConfig.KalenderUmfang[0]));
                 * System.out.println("Höhe in Pixel = "+maxhoch);
                 * System.out.println(me.getComponent().getName());
                 * System.out.println(fPixelZuMinute);
                 * System.out.println("Minuten = "+Math.round(Float.valueOf(fPixelZuMinute*Float
                 * .valueOf(me.getY())))); System.out.println("Position = "+(me.getY()));
                 * System.out.println(uhrZeit);
                 */
                // System.out.println(
                // ((JTerminInternal)me.getComponent().getParent().getParent()).getContentPane());
