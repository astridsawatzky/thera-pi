...
public class KassenNeuKurz extends JXPanel implements ActionListener, KeyListener, FocusListener {
                ...
                protected Void doInBackground() throws Exception {
                    if (tfs[1].getText()
                        ...
                        JOptionPane.showMessageDialog(null,
                                "Also der Name der neuen Krankenkasse sollte wenigstens angegeben werden!");
                        return null;
                    }
                    int iid;
                    ...
                    kkBuffer.append(", preisgruppe ='" + Integer.toString(tarifGruppe.getSelectedIndex() + 1)
                                                                .toString()
                            + "', ");
    ...
    public JScrollPane getFelderPanel() {
        ...
        tfs[15].setName("id");
        /*
         * jtf[13] = new JRtaTextField("ZAHLEN", true); jtf[13].setName("IK_KASSE");
         * //aus Kostentr�gerdatei/Karte einlesen? jtf[14] = new JRtaTextField("ZAHLEN",
         * true); jtf[14].setName("IK_KOSTENT"); jtf[15] = new JRtaTextField("ZAHLEN",
         * true); jtf[15].setName("IK_PHYSIKA"); jtf[16] = new JRtaTextField("ZAHLEN",
         * true); jtf[16].setName("IK_NUTZER"); jtf[17] = new JRtaTextField("ZAHLEN",
         * true); jtf[17].setName("IK_PAPIER");
         */
