...
public class GutachtenWahl extends RehaSmartDialog implements ActionListener {
    /**
     *
     */
    ...
    private JPanel getGutachten() { // 1 2 3 4 5
        ...
        FormLayout lay2 = new FormLayout("fill:0:grow(0.33),60dlu,fill:0:grow(0.33),60dlu,fill:0:grow(0.33)", "p");
        ...
        try {
            if (evt.getDetails()[0] != null) {
                if (evt.getDetails()[0].equals(this.getName())) {
                    ...
                    super.dispose();
                    this.dispose();
                    // System.out.println("****************GutachtenWahl -> Listener
                    // entfernt**************");
                }
            }
