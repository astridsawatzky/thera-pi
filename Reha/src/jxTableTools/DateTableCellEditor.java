...
public class DateTableCellEditor extends DefaultCellEditor implements KeyListener {
    ...
    public DateTableCellEditor() {
        ...
        /*
         * MaskFormatter formatter = null; try { if (Locale.getDefault ().getLanguage
         * ().equals (Locale.GERMANY.getLanguage())) {
         * ////System.out.println("Formatter - Locale = Germany"); formatter = new
         * MaskFormatter ("##.##.####"); } else { formatter = new MaskFormatter
         * ("####-##-##"); }
         * 
         ...
         * (this.getClass().getName(),"getDateMask", ignored); } DefaultFormatterFactory
        ...
        ftf.getActionMap()
           .put("check", new AbstractAction() {
               ...
               public void actionPerformed(ActionEvent e) {
                    ...
                    * //System.out.println("Ung�ltige in ActionPerformed Eingabe ---------> "+ftf.
                    * getText()); if (userSaysRevert()) { //reverted ftf.postActionEvent();
                    * //inform the editor } }else{ //ftf.commitEdit(); //so use it.
    ...
    public Object getCellEditorValue() {
         ...
         * return Integer.valueOf(((Number)o).intValue()); } else { if (DEBUG) {
