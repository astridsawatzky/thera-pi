...
public class ArztNeuanlage extends JXPanel implements ActionListener, KeyListener, FocusListener {
    ...
    public JScrollPane getFelderPanel() {
        ...
        /*
         * jpan.add(new JLabel("Notitzen"),cc.xy(1, 32)); jta = new JTextArea();
         * jta.setFont(new Font("Courier",Font.PLAIN,11)); jta.setLineWrap(true);
         * jta.setName("mtext"); jta.setWrapStyleWord(true); jta.setEditable(true);
         * jta.setBackground(Color.WHITE); jta.setForeground(Color.RED); JScrollPane
         * span = JCompTools.getTransparentScrollPane(jta); span.validate();
    ...
    public void tabelleAktualisieren() {
        ...
        List<String> list = Arrays.asList(new String[] { tfs[7].getText(), tfs[2].getText(), tfs[3].getText(),
                tfs[4].getText(), tfs[6].getText(), tfs[9].getText(), tfs[10].getText(), tfs[12].getText(),
