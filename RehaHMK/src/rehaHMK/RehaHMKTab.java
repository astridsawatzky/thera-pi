...
public class RehaHMKTab extends JXPanel implements ChangeListener {
    ...
    public RehaHMKTab() {
        ...
        /*
         * jxh.setTitle("Nach machbaren Indikationsschlüsseln suchen"); jxh.
         * setDescription("<html><br>Sie wissen welche Behandlungsformen gut sind für Ihren Patienten?<br>"
         * +
