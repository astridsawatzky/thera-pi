...
public class TheraPiLocations {
    ...
    /**
     * Get the base directory of Thera-Pi program files. Replaces proghome, but does
     * not include trailingg separator
     * 
    ...
    /**
     * Get the directory for icons. Replaces proghome + "icons".
     * 
    ...
    /**
     * Get the common directory for INI files. Replaces proghome + "ini" (without
     * IK.)
     * 
    ...
    /**
     * Get the directory with default INI files. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the directory with default document templates. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the directory with default temp files. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the directory with default EDIFACT files. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the directory with default keystore files. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the directory with default vacation files. To be used in
     * SysUtilMandanten.neuSpeichern().
     * 
    ...
    /**
     * Get the institution specific directory for INI files. Replaces proghome +
     * "ini/" + Reha.aktIK or proghome + "ini/" + "510841109".
     * 
    ...
    /**
     * Get the institution specific directory for EDIFACT files. Replaces proghome +
     * "edifact/" + Reha.aktIK or proghome + "edifact/" + "510841109".
     * 
     * @param IK identification of current institution or NULL for initial IK
     * 
    ...
    /**
     * Get the institution specific directory for document template files. Replaces
     * proghome + "vorlagen/" + Reha.aktIK or proghome + "vorlagen/" + "510841109".
     * 
     * @param IK identification of current institution or NULL for initial IK
     * 
    ...
    /**
     * Get the institution specific keystore file name. Replaces proghome +
     * "keystore/" + Reha.aktIK + "/" + Reha.aktIK + ".p12" or similar.
     * 
     * @param IK identification of current institution or NULL for initial IK
     * 
    ...
    /**
     * Get the institution specific keystore directory name. Replaces proghome +
     * "keystore/" + Reha.aktIK or proghome + "keystore/" + "510841109".
     * 
     * @param IK identification of current institution or NULL for initial IK
     * 
