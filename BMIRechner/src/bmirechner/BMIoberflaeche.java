...
public class BMIoberflaeche extends JXPanel implements ListSelectionListener, ActionListener {
    ...
    private JPanel getTeil2() {
        FormLayout teil2Pan = new FormLayout("0dlu,p,10dlu,60dlu,0dlu", "p,10dlu,p,5dlu,p,5dlu,p,5dlu,p,5dlu,p,10dlu");
    ...
    private void doRechnen() {
        ...
        BigDecimal gross = new BigDecimal(Double.parseDouble(cm.getText()
                                                               .trim())
                / 100);
        gross = gross.pow(2);
        // System.out.println(gross);
        BigDecimal gewicht = new BigDecimal(Double.parseDouble(masse.getText()
                                                                    .trim()
                                                                    .replace(",", ".")));
        ...
        Double[][] dvergleich = { { 0.0, 18.4 }, { 18.5, 24.9 }, { 25.0, 29.9 }, { 30.0, 34.9 }, { 35.0, 39.9 },
                { 40.0, 0.00 } };
