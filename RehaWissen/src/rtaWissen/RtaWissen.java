...
public class RtaWissen extends JXPanel implements KeyListener, ComponentListener, ActionListener, AncestorListener {
    ...
    public RtaWissen(int setOben, String url) {
        ...
        // webBrowserPanel.setBorder(BorderFactory.createTitledBorder("Native Web
        // Browser component"));
        ...
        // System.out.println("xulruntime =
        // "+System.getProperty("nativeswing.webbrowser.runtime"));
        ...
        webBrowser.addWebBrowserListener(new WebBrowserAdapter() {
             ...
             * { String commandText = command; if(args.length > 0) { commandText += " " +
             * Arrays.toString(args); } if("store".equals(command)) { String data = args[0];
             * if(JOptionPane.showConfirmDialog(webBrowser, "Do you want to store \"" + data
        ...
        /*
         * webBrowser = new JWebBrowser(); webBrowser.setAddressBarVisible(false);
         * webBrowser.setDoubleBuffered(true); webBrowser.setURL(Url);
    ...
    public void FensterSchliessen(String welches) {
        ...
        // webBrowser.dispose();
        // Reha.instance.TPschliessen(setOben,(Object)
        // this.getParent().getParent().getParent().getParent().getParent(),welches);
    }
        ...
        SwingUtilities.invokeLater(new Runnable() {
            ...
            public void run() {
                ...
                frame.getContentPane()
                     .add(new SourceFenster(buf), BorderLayout.CENTER);
