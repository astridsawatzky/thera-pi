...
public class CMSTest implements Test {
    ...
    // enveloepd data
    //
    byte[] envDataKeyTrns = Base64.decode("MIAGCSqGSIb3DQEHA6CAMIACAQAxgcQwgcECAQAwKjAlMRYwFAYDVQQKEw1Cb3Vu"
            ...
            + "ZQMEARYEEAfxLMWeaBOTTZQwUq0Y5FuggAQgwOJhL04rjSZCBCSOv5i5XpFfGsOd" + "YSHSqwntGpFqCx4AAAAAAAAAAAAA");

    byte[] envDataKEK = Base64.decode("MIAGCSqGSIb3DQEHA6CAMIACAQIxUqJQAgEEMAcEBQECAwQFMBAGCyqGSIb3DQEJE"
    ...
    // signed data
    //
    byte[] signedData = Base64.decode("MIAGCSqGSIb3DQEHAqCAMIACAQExCzAJBgUrDgMCGgUAMIAGCSqGSIb3DQEHAaCA"
    ...
    private TestResult envelopedTest() {
        try {
            ...
            if (recip.getInfo() instanceof KeyTransRecipientInfo) {
                ...
                System.out.println(inf.getEncryptedKey()
                                      .parser());
