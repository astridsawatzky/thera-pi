...
public class NebraskaPanel extends JPanel implements ActionListener {
    ...
    public NebraskaPanel() {
        ...
        // 9 10 11
                "5dlu,50dlu,fill:0:grow(1.0)", "fill:0:grow(1.0),2dlu,p,2dlu,p,2dlu");
        ...
        /*
         * try { KeyPair kp = generateRSAKeyPair();
         * System.out.println("Private key:\n"+kp.getPrivate());
         * System.out.println("Public key:\n"+kp.getPublic()); X509Certificate cert =
         * generateV3Certificate(kp); cert.checkValidity(new Date());
         * cert.verify(cert.getPublicKey());
         * System.out.println("G�ltiges Zertifikat wurde generiert");
         * //System.out.println(new String(cert.getEncoded())); ByteArrayOutputStream
         * bOut = new ByteArrayOutputStream(); bOut.write(cert.getEncoded());
         * bOut.flush(); bOut.close(); InputStream in = new
         * ByteArrayInputStream(bOut.toByteArray()); CertificateFactory fact =
         * CertificateFactory.getInstance("X.509",Constants.SECURITY_PROVIDER);
         * X509Certificate x509Cert; Collection collection = new ArrayList(); x509Cert =
         ...
         * FileWriter("C:/Lost+Found/verschluesselung/51084110.crq"))); bOut = new
         * ByteArrayOutputStream ( ) ; PEMWriter pemWrt = new PEMWriter(new
         * OutputStreamWriter(bOut)); pemWrt.writeObject(request); pemWrt.close();
        ...
        // System.out.println(x509Cert);
        /*
         * Thread.sleep(100); //RSAPublicKey pubkey =
         * getPubKeyFromFile("C:/Lost+Found/verschluesselung/einschluessel.pem.txt");
         * //RSAPublicKey pubkey =
         * getPubKeyFromFile("C:\\Lost+Found\\verschluesselung\\ANNAHME.KEY");
         * getPubKeyFromFile("C:\\Lost+Found\\verschluesselung\\51084110.CRP");
         * 
         * Thread.sleep(100); //System.out.println(new String( pubkey.getEncoded()) );
         * 
         * 
         * //System.exit(0);
         * 
         * } catch (NoSuchAlgorithmException e) { e.printStackTrace(); } catch
         * (NoSuchProviderException e) { e.printStackTrace(); } catch
         * (InvalidKeyException e) { e.printStackTrace(); } catch (SecurityException e)
         * { e.printStackTrace(); } catch (SignatureException e) { e.printStackTrace();
         * } catch (CertificateExpiredException e) { e.printStackTrace(); } catch
         * (CertificateNotYetValidException e) { e.printStackTrace(); } catch
         * (CertificateException e) { e.printStackTrace(); } catch (IOException e) {
    ...
    public static X509Certificate generateV3Certificate(KeyPair pair)
        ...
        try {
            ...
            System.out.println("HashCode des PublicKey = " + pair.getPublic()
                                                                 .hashCode());
    ...
    public static PKCS10CertificationRequest generateRequest(KeyPair pair)
        ...
        return new PKCS10CertificationRequest(Constants.SHA1WITH_RSA,
                new X500Principal(
                        "CN=Herr Steinhilber," + "OU=IK510844109,OU=Reutlinger Therapie- und Analysezentrum GmbH,"
    ...
    public void doCertificate() {
        ...
        try {
            ...
            // CertificateFactory.getInstance(Constants.CERTIFICATE_TYPE,Constants.SECURITY_PROVIDER);
