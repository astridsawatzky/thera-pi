...
//	public static final String OPENOFFICE_JARS = "C:/RehaVerwaltung/RTAJars/openofficeorg";
    ...
    public Constants() {
        /*
         * if(System.getProperty("os.name").contains("Windows")){ INI_FILE =
         * System.getProperty("user.dir")+ File.separator +"nebraska_windows.conf";
         * }else if(System.getProperty("os.name").contains("Linux")){ INI_FILE =
         * System.getProperty("user.dir")+ File.separator +"nebraska_linux.conf"; }else
         * if(System.getProperty("os.name").contains("String für MaxOSX????")){ INI_FILE
         * = System.getProperty("user.dir")+ File.separator +"nebraska_mac.conf"; }
         * 
         * INIFile inif = new INIFile(INI_FILE); System.out.println(INI_FILE);
         ...
         * 
         * PRAXIS_CE = inif.getStringProperty("Praxis","PRAXIS_CE" ); PRAXIS_OU_FIRMA =
         * inif.getStringProperty("Praxis","PRAXIS_OU_FIRMA" ); PRAXIS_OU_ALIAS =
         * inif.getStringProperty("Praxis","PRAXIS_OU_ALIAS" ); PRAXIS_O =
         * inif.getStringProperty("Praxis","PRAXIS_O" ); PRAXIS_CN =
         * inif.getStringProperty("Praxis","PRAXIS_CN" ); // In der Entwicklungsversion
         * steht das Passwort noch im Klartext PRAXIS_KS_PW =
         * inif.getStringProperty("Praxis","PRAXIS_KS_PW" );
         * 
         * TEST_CA_CE = inif.getStringProperty("TestCA","TEST_CA_CE" ); TEST_CA_OU_FIRMA
         * = inif.getStringProperty("TestCA","TEST_CA_OU_FIRMA" ); TEST_CA_OU_ALIAS =
         * inif.getStringProperty("TestCA","TEST_CA_OU_ALIAS" ); TEST_CA_O =
         * inif.getStringProperty("TestCA","TEST_CA_O" ); TEST_CA_CN =
         * inif.getStringProperty("TestCA","TEST_CA_CN" ); // In der Entwicklungsversion
         * steht das Passwort noch im Klartext TEST_CA_KS_PW =
         * inif.getStringProperty("TestCA","TEST_CA_KS_PW" );
