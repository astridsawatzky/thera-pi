...
/**
 * This class represents a principal (subject or issuer of a certificate). It is
 * used to split the distinguished name string into the usual fields and
...
public class NebraskaPrincipal {
    ...
    /**
     * Create an alias from the name fields. Uses the institution ID (IK) field if
     * present, otherwise the full distinguished name without spaces.
     * 
     * @return the alias
     */
     ...
     * @param personName
     */
    public NebraskaPrincipal(String country, String organization, String institutionName, String institutionID,
            String personName) {
        this.country = country;
        this.organization = organization;
        this.institutionName = institutionName;
    ...
    /**
     * Helper class to append only existing name parts to a distinguished name
     * string.
     * 
     * @author bodo
     *
    ...
    private class DistinguishedNameBuffer {
        ...
        /**
         * Append key=prefixvalue if value is not null. Intended for institution ID
         * (IK).
         * 
         * @param key    key string
    ...
    /**
     * Reconstruct distinguished name from name parts if necessary and return
     * distinguished name.
     * 
    ...
    public boolean equals(Object o) {
        ...
        if (o == null)
            return false;
        if (!(o instanceof NebraskaPrincipal))
            return false;

        NebraskaPrincipal other = (NebraskaPrincipal) o;
        /*
         * If a field exists in one object but not in the other, the objects are not
         * equal.
         */
        if ((this.country == null) != (other.country == null))
            return false;
        if ((this.organization == null) != (other.organization == null))
            return false;
        if ((this.institutionID == null) != (other.institutionID == null))
            return false;
        if ((this.institutionName == null) != (other.institutionName == null))
            return false;
        if ((this.personName == null) != (other.personName == null))
            return false;

        /*
         * if any of the existing fields is not equal to the corresponding field of the
         * other object they are not equal.
         */
        if (this.country != null && !this.country.equals(other.country))
            return false;
        if (this.organization != null && !this.organization.equals(other.organization))
            return false;
        if (this.institutionID != null && !this.institutionID.equals(other.institutionID))
            return false;
        if (this.institutionName != null && !this.institutionName.equals(other.institutionName))
            return false;
        if (this.personName != null && !this.personName.equals(other.personName))
            return false;
