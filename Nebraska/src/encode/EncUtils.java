...
public class EncUtils {
    ...
    public static byte[] doNextEncTest4(String inFile, String kkAlias) throws Exception {
        ...
        // certRecipient = (X509Certificate) store.getCertificate(kkAlias);
        // IKK-Bundesverband
        ...
        /****************** Signed Data *************************/
        CreatePKCS7 pkcs = new CreatePKCS7(kkAlias, Constants.PRAXIS_OU_ALIAS, Constants.PRAXIS_KS_PW, store);
        ...
        CMSEnvelopedData envelopedData = gen.generate(bout/* signed.getSignedContent() */,
