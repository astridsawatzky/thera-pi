...
//         System.out.println("Aus Pem "+info.getDERObject());
            ...
            // System.out.println("DERObject getDEREncoded = "+new
            // String(derob.getDEREncoded()));
            ...
            ASN1Set attributes = certRequest.getCertificationRequestInfo()
                                            .getAttributes();
            ...
            for (int i = 0; i != attributes.size(); i++) {
                ...
                if (attr.getAttrType()
                    ...
                    X509Extensions extensions = X509Extensions.getInstance(attr.getAttrValues()
                                                                               .getObjectAt(0));
                    ...
                    while (e.hasMoreElements()) {
                        ...
                        ASN1InputStream aIn = new ASN1InputStream(extVal.getValue()
                                                                        .getEncoded());
